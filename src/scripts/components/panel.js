...
export function createPanel (type) {
  ...
  switch (type) {
    case 'todo':
      panel.append(createButton('panel-todo-button', 'panel__button', 'New card', 'button'))
      break
    case 'done': panel.append(createButton('panel-done-button', 'panel__button', 'Delete All', 'button'))
  }
